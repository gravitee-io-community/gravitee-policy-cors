...
public class CorsPolicyHeaderAccessControlAllowOrigin extends CorsPolicyHeader {
    ...
    public void testHeaderWhenConfigurationDeactivatedAndExistingInResponse() throws Exception {
        ...
        headers.setAll(new HashMap<String, String>() {
            {
                put(HttpHeaders.ACCESS_CONTROL_ALLOW_ORIGIN, DEFAULT_HEADER_VALUE);
            }
        });
        ...
        assertEquals(DEFAULT_HEADER_VALUE, headers.getFirst(HttpHeaders.ACCESS_CONTROL_ALLOW_ORIGIN));
    ...
    public void testHeaderWhenConfigurationActivatedAndNotOverridingWithNonNullValueAndNotExistingInResponse() throws Exception {
        ...
        assertEquals(1, headers.size());
        assertEquals("allowed.domain.com", headers.getFirst(HttpHeaders.ACCESS_CONTROL_ALLOW_ORIGIN));
        verify(policyChain).doNext(request, response);
    }
